# The functions in this file is used to tackle the gradient computation problem happened in 2.4>tf>=2.2
import sys
import numpy as np
...
from tensorflow.python.keras.mixed_precision.experimental import (
    loss_scale_optimizer as lso)# cant use this name in 2.4.1
# import tensorflow.keras.mixed_precision.experimental as lso
